...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "pages" DROP COLUMN "layout_preset";
  ALTER TABLE "_pages_v" DROP COLUMN "version_layout_preset";
  DROP TYPE "public"."enum_pages_layout_preset";
  DROP TYPE "public"."enum__pages_v_version_layout_preset";`);
}
