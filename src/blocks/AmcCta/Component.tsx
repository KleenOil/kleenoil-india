...
import { DEFAULT_AMC_CTA } from '@/lib/cms/amc';
import { cn } from '@/lib/utils';

type CtaItem = { link?: CmsLink | null };

export type AmcCtaBlockData = {
  blockType: 'amc-cta';
  eyebrow?: string | null;
  heading?: string | null;
  subtext?: string | null;
...
export function AmcCtaBlock({ block }: { block?: AmcCtaBlockData | null }) {
  const defaults = DEFAULT_AMC_CTA;
