...
export async function ArticlesFeaturedBlock({ block }: ArticlesFeaturedBlockProps) {
  ...
  const eyebrow = cmsText(block?.eyebrow, DEFAULT_ARTICLES_FEATURED.eyebrow, hasCms);
  const heading = cmsText(block?.heading, DEFAULT_ARTICLES_FEATURED.heading, hasCms);
  const description = cmsText(block?.description, DEFAULT_ARTICLES_FEATURED.description, hasCms);
